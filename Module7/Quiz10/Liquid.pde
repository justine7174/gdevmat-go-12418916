public class Liquid
{
  ...
  // chec if a given walker is in contacct or colliding with our liquid
  ...
  public PVector calculatingDragFrorce(Walker walker)
  {
    
    //drag manitude is cofficient of drag * speed squared
